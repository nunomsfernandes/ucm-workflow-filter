...
--------------------------------------------------------
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("DID" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("DDOCNAME" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("NUM_FATURA" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("NIF_CLIENTE" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("COD_UTILIZADOR" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("NOM_DOCUMENTO" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("DAT_CRIACAO" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" MODIFY ("COD_STATUS" NOT NULL ENABLE);
ALTER TABLE "AMT_AR_APPROVE_EBS_INTEGRATION" ADD CONSTRAINT "AMT_AR_APPROVE_EBS_INTEGRA_PK" PRIMARY KEY ("DID");
